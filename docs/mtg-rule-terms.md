...
- Magic: The Gathering Comprehensive Rules TXT: `https://media.wizards.com/2026/downloads/MagicCompRules%2020260619.txt`
- 参照CR版: 2026-06-19 effective
...
| token | カードでないパーマネント | battlefield外へ移動したイベントを作り、誘発確認後にSBAで消滅(CR111.7/704.5d) |
...
| mana ability | CR605の条件を満たす、マナを加える能力 | スタックに置かず即解決。既存 `tapForMana` / `addMana` に接続し、一般の `addAbilityToStack` へ流さない |
