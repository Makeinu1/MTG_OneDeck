...
describe('review O4P-06F four-browser production release', () => {
  it('freezes the exact acceptance-only authority and unchanged product boundary', () => {
    ...
    expect(onlineTsconfig.include).toEqual(['./o4p-03d-evidence.ts', './o4p-06f-four-browser-evidence.ts', './o4p-09i-full-match-evidence.ts', './remote-priority-journey-evidence.ts']);
  });
