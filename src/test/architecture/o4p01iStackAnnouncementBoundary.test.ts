...
const allowedOnlineRootNames = new Set(['architecture', 'bootstrap', 'browser', 'cloudflare', 'deckSubmission', 'displayPairing', 'guidedActions', 'headless', 'lobby', 'projection', 'protocol', 'publicApp', 'room', 'tableDisplay', 'workbench']);
const categoryOrder = [
  'stack-edge',
  'forbidden-import',
  'forbidden-symbol',
