...
const allowedOnlineRootNames = new Set(['architecture', 'bootstrap', 'browser', 'cloudflare', 'displayPairing', 'guidedActions', 'headless', 'lobby', 'projection', 'protocol', 'room', 'tableDisplay', 'workbench']);
const categoryOrder = [
  'stack-edge',
  'forbidden-import',
  'forbidden-symbol',
