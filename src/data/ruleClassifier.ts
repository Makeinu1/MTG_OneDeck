...
const KEYWORD_DEFINITIONS: readonly KeywordDefinition[] = [
...
function cardTexts(def: CardDef): string[] {
...
function removeReminderAndQuotes(text: string): string {
  let output = '';
...
function parsePureKeywordLine(core: string): KeywordClause[] | null {
