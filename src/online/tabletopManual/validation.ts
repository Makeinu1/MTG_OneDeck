...
export function validateOnlineTabletopIntentEnvelopeV1(input: unknown): OnlineTabletopIntentValidationResultV1 {
  ...
  const primitiveFields = ['kind', 'objectId', 'targetObjectId', 'destination', 'zone', 'order', 'count', 'tapped', 'counterKind', 'color', 'field', 'delta', 'gainingControllerPlayerId', 'amount', 'noteId', 'entryId', 'text', 'label', 'sourceObjectId', 'tokenSeed', 'definitionId', 'definition'] as const;
