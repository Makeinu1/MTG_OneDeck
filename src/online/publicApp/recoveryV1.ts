...
const ERROR_CODES = ['ROOM_NOT_FOUND', 'ROOM_EXPIRED', 'INVITE_INVALID', 'INVITE_ROTATED', 'ADMISSION_CLOSED', 'ROOM_FULL', 'PARTICIPANT_RECOVERABLE', 'CREDENTIAL_REJECTED', 'CREDENTIAL_KICKED', 'HOST_REQUIRED', 'INVALID_LIFECYCLE', 'PREGAME_REQUIRES_40_LIFE', 'DECK_REQUIRED', 'DECK_RESOLVING', 'DECK_NEEDS_ATTENTION', 'PLAYERS_NOT_READY', 'CLIENT_UPGRADE_REQUIRED', 'RATE_LIMITED', 'SERVICE_UNAVAILABLE'] as const;
