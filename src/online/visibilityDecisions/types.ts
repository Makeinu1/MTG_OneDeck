...
export const ONLINE_VISIBILITY_INTENT_SCHEMA_VERSION_V2 = 2 as const;
...
export type OnlineVisibilityIntentEnvelopeV2 = Readonly<{
  readonly kind: 'online-visibility-intent-v2';
  readonly schemaVersion: typeof ONLINE_VISIBILITY_INTENT_SCHEMA_VERSION_V2;
  readonly commandId: string;
  readonly baseRevision: number;
  readonly openChoice: Readonly<{ readonly count: number }>;
}>;
export type OnlineVisibilityIntentEnvelope = OnlineVisibilityIntentEnvelopeV1 | OnlineVisibilityIntentEnvelopeV2;
...
export type OnlineVisibilityValidationResult = Readonly<{ readonly ok: true; readonly value: OnlineVisibilityIntentEnvelope }> | Readonly<{ readonly ok: false; readonly issues: readonly OnlineVisibilityValidationIssueV1[] }>;
export type OnlineVisibilityBindingInputV1 = Readonly<{ readonly state: OnlineVariableProtocolStateV2; readonly participantId: string; readonly transportCredential?: string; readonly envelope: OnlineVisibilityIntentEnvelope; readonly projection?: unknown; readonly existingCommand?: unknown }>;
